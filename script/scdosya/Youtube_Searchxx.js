registerPlugin({
    name: 'Youtube Arama Scripti - bygalacos',
    version: '1.5',
    engine: '>= 0.9.21',
    ...
    vars: [
        {
            name: 'yt_apikey',
            title: 'Api Key Oluşturmanıza gerek yok size api keyide veriyoruz AIzaSyCFMQjGrV4FNlTNsd7mU19wUjOOsqOqEiw kopyala bir alta yapıştır.',
            type: 'string'
        },
        {
            name: 'ytdl_action',
            title: 'Ayarlar [1] Önerdiğimiz Yerleri Seçin',
            type: 'select',
            indent: 1,
            options: [
                'Burayı Elleme',
                'İndirmesini İstiyorsan Seç ',
                'Sadece Çal <-- Önerilen Ayar'
            ]
        },
        {
            name: 'ytdl_playback',
            title: 'Ayarlar [2] Önerdiğimiz Yerleri Seçin',
            type: 'select',
            indent: 1,
            options: [
                'Burayı Elleme',
        ...
        {
            name: 'yt_catchurl',
            title: 'Kanaldan Atılan Youtube Linkleri Açılsın İstiyorsan İşaretle',
            type: 'checkbox'
        },
        {
        ...
        },
        {
            ...
            type: 'multiline',
            placeholder: '[B]You[/B][COLOR=#ff0000]Tube[/COLOR] - Title: {title} - By: {upload_by}'
        },
        {
            name: 'yt_titleblacklist',
            title: 'Aranmasını İstemediğiniz Kelimeleri Giriniz Örnek : aleyna,tilki,enes,batur,bygalacos',
            type: 'string',
        ...
        },
        {
            ...
            title: 'Bu özelliği kötü amaçlı kullananları banlama özelliğidir tsdeki kullanıcı adını girmeniz yeterli',
            type: 'string',
            placeholder: 'bygalacos,bygalacos...'
        },
        {
            name: 'command_permissionsServerGroups',
            title: 'Botu Sadece Belli Bir Yetkinin Kullanmasını İstiyorsanız O Yetkinin Grup id sini yazınız',
            type: 'array',
            vars: [
                {
                    name: 'group',
    ...
    var youtube = {
        config: {
            ...
            plugin: {
                ...
                command_message: config.command_message || '[B]You[/B][COLOR=#ff0000]Tube[/COLOR] - Title: {title} - By: {upload_by}',
